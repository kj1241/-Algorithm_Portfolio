...
bool WinAPI::InitChartWindow(threadArg* _arg, RECT parerentPoistion)
{
    ...
    windowClass.lpszClassName = L"VisitorSolution_test";
...
void WinAPI::InitShape()
{
    ...
    for (int i = 0; i < 100000; ++i)
    {
        ...
        {
        case 0:
            shapes.emplace_back(std::make_unique<Circle>(hdc,(rand()%12000)/10, (rand()%8000)/10,RGB(rand()%255, rand()%255, rand()%255), rand()%20));
            break;
        case 1:
            shapes.emplace_back(std::make_unique<Square>(hdc, (rand() % 12000) / 10, (rand() % 8000) / 10, RGB(rand() % 255, rand() % 255, rand() % 255), rand() % 20));
            break;
        case 2:
            shapes.emplace_back(std::make_unique<_Ellipse>(hdc, (rand() % 12000) / 10, (rand() % 8000) / 10, RGB(rand() % 255, rand() % 255, rand() % 255), rand() % 20,rand()%20));
            break;
        case 3:
            shapes.emplace_back(std::make_unique<_Rectangle>(hdc, (rand() % 12000) / 10, (rand() % 8000) / 10, RGB(rand() % 255, rand() % 255, rand() % 255), rand() % 20,rand()%20));
            break;
        }
    }
